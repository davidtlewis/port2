...
urlpatterns = [
    ...
    path("transactionsfiltered/", TransactionListViewFiltered.as_view(),
         name='transactionsfiltered'),
    path("holdings/", HoldingListView.as_view(), name='holdings'),
    path("holdingsfiltered/", HoldingListViewFiltered.as_view(),
         name='holdingsfiltered'),
    ...
    path("stockholdingsummary/", views.StockHoldingView.as_view(),
         name='stockholdingsummary'),
